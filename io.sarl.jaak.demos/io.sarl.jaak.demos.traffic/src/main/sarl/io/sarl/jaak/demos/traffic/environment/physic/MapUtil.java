...
public class MapUtil {
	...
	private static List<Point2i> urgencyVehicleSpawners;
	...
	/** Replies the positions of the spawning for urgency vehicles.
	 * 
	 * @return the positions.
	 */
	public static List<Point2i> getUrgencyVehicleSpawningPositions() {
		synchronized(Astar.class) {
			ensureWorldModel();
			return urgencyVehicleSpawners;
		}
	}
	...
	private static void ensureWorldModel() {
		if (worldModel == null || trafficLights == null || crashPositions == null || standardVehicleSpawners == null || urgencyVehicleSpawners == null) {
			...
			try {
				...
				urgencyVehicleSpawners = new ArrayList<>();
				...
				for (int x = 0; x < img.getWidth(); ++x) {
					for (int y = 0; y < img.getHeight(); ++y) {
						...
						case COLOR_ROAD:
							...
							break;
						case COLOR_URGENCY_SPAWNER:
							wms(x, y, GroundType.ROAD);
							urgencyVehicleSpawners.add(new Point2i(x, y));
							break;
						...
						case COLOR_AGENT_DESTROYER:
							...
							break;
						case COLOR_URGENCY_LOCATION:
							wms(x, y, GroundType.URGENCY_LOCATION);
