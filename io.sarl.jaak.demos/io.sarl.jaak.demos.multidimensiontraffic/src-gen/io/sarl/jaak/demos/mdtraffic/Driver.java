...
public class Driver extends io.sarl.jaak.demos.traffic.Driver {
  ...
  public void _handle_Initialize_0(final Initialize occurrence) {
    ...
    Address _register = this.outputSpace.register(_asEventListener);
    this.address = _register;
    super._handle_Initialize_0(occurrence);
  }
  
  public Behavior createEmergencyDriverBehavior() {
    return new EmergencyDriver(this, this.outputSpace, this.address);
  }
   ...
   */
  @Generated
  public Driver(final UUID parentID) {
    super(parentID, null);
  }
