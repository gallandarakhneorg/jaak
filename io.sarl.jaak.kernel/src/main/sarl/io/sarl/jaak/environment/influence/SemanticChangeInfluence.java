 ...
 */
public class SemanticChangeInfluence extends ObjectChangeInfluence<EnvironmentalObject> {
	...
	public String toString() {
		...
		Serializable semantic = this.newSemantic;
	...
	public boolean changeBody(TurtleBody body) {
		body.setSemantic(this.newSemantic);
		return true;
	}
